...
- `wrx-jp.packed.bin`: packed image generated in the build directory, when Python and `crcmod` are available.
- `release/wrx-jp-v4.3J5.packed.bin`: versioned release-equivalent packed image.
